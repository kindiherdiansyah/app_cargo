...
<div class="site-index">
    ...
    <br>
        ...
        <center><p><a class="btn btn-lg btn-primary" href="/kargo/frontend/web/index.php?r=process%2Findex">CEK TRACKING</a></p></center>
        </div>
    <br>
    </div>
    ...
    <div class="col-lg-4">
        ...
        <br>    
        <div style="text-align: justify;">
        <center><p><a class="btn btn-lg btn-primary" href="/kargo/frontend/web/index.php?r=kantor%2Findex">LOCATION</a></p></center>
        </div>
    </div>
    ...
    <div class="col-lg-4">
        ...
        <br>
        <div style="text-align: justify;">
        <center><p><a class="btn btn-lg btn-primary" href="/kargo/frontend/web/index.php?r=tarif-cargo%2Findex">CEK TARIF</a></p></center>
        </div>
        <br>
    </div>
    <br>
